...
class Plot(object):
    ...
    def mesh(
        ...
        gasdens = sim.load_field(
            fields=["gasdens"], snapshot=snapshot, slice=slice, interpolate=True
        )
        ...
        try:
            ...
            if X is None or Y is None:
                raise RuntimeError(
                    "Could not obtain var1_mesh/var2_mesh from loaded field. Use interpolate=True and a valid slice."
                )
